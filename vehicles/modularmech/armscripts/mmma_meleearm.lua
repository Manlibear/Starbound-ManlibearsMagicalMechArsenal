...
function MeleeArm:windupState()
  ...
  while stateTimer > 0 do
    animator.rotateTransformationGroup(self.armName, (self.aimAngle + self.windupAngle) - 45, self.shoulderOffset)
...
function MeleeArm:fireState(fromAngle, toAngle, allowCombo)
  ...
  while stateTimer > 0 do
    ...
    animator.rotateTransformationGroup(self.armName, (self.aimAngle + currentAngle) - 45, self.shoulderOffset)
